...
import { MessageSquare, Send, Mail, MapPin, CheckCircle2, AlertCircle } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="bg-slate-900/40 backdrop-blur-md rounded-xl p-6 border border-white/10 flex flex-col gap-2 hover:bg-slate-900/60 hover:border-white/20 transition-all shadow-lg">
              <h4 className="font-semibold text-[16px] text-[#FFFFFF] mb-1 flex items-center gap-2">
                <svg viewBox="0 0 24 24" className="w-5 h-5 text-[#25D366] flex-shrink-0" fill="currentColor" aria-hidden="true">
              ...
              <div className="space-y-1">
                <a
                  href="https://wa.me/50687587740"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-normal text-[16px] text-[#E2E8F0] leading-[1.5] hover:text-emerald-400 transition-colors block cursor-pointer"
                >
                  +506 8758 7740
                </a>
              </div>
