  ...
  return (
    <div className="flex flex-col w-full overflow-hidden font-sans bg-[#0B1121]">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-[#0B1121] to-[#1E293B] overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-[120px] relative z-10 flex flex-col items-center text-center">
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="text-[40px] md:text-[56px] lg:text-[64px] font-bold text-[#FFFFFF] leading-tight mb-6 max-w-4xl [text-shadow:0_2px_20px_rgba(0,0,0,0.5)]"
          >
            {t({
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-[#0B1121] py-20">
        ...
        <div className="container mx-auto px-4 md:px-10 lg:px-[120px] relative z-10 flex flex-col items-center justify-center">
