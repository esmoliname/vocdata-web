  ...
  return (
    <div className="flex flex-col w-full font-sans bg-[#0B1121]">
            ...
            {[
              ...
              >
                ...
                <img
                  src={srv.imageUrl}
                  alt={srv.title}
                  className="w-full aspect-video object-cover rounded-t-2xl opacity-100 mix-blend-normal md:opacity-75 md:mix-blend-luminosity md:hover:mix-blend-normal md:hover:opacity-100 md:hover:scale-105 transition-all duration-500"
                />
      ...
      <section className="py-24 bg-[#FFFFFF]">
        <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-[120px] text-center">
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
